...
/**
 * A custom ringbuffer merge policy that returns an union of items that are
 * instances of {@link Integer} from both ringbuffers.
 * <p>
 * This policy is applicable only for {@link com.hazelcast.ringbuffer.Ringbuffer}
 * because of the required types.
 */
public class RingbufferMergeIntegerValuesMergePolicy
