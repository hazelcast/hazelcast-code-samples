...
/**
 * <P>Load some test data into the cluster at start-up.
 * </P>
 */
@Component
@Slf4j
public class TestDataLoader implements CommandLineRunner {
	...
	/**
	 * <P>Since the tests should see the maps lose some or
	 * no data, but not all data, we can use the emptiness
	 * of the maps as the indicator that data load hasn't
	 * happened at all.
	 * </P>
	 * <P>There is a minor race condition here as we test
	...
	public void run(String... arg0) throws Exception {
		...
		IMap<Integer, String> safeMap = this.hazelcastInstance.getMap(Constants.MAP_NAME_SAFE);
		IMap<Integer, String> unsafeMap = this.hazelcastInstance.getMap(Constants.MAP_NAME_UNSAFE);
