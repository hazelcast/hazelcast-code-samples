...
/**
 * <P>Debug diagnostic print of database and Hazelcast content.
 * </P>
 */
@Component
@Slf4j
public class DebugCommands implements CommandMarker {
	...
	/**
	 * <P>Show what is in the database. Would be cleaner with lambdas.
	 * </P>
	 */
	...
	/**
	 * <P>Show what is in Hazelcast. Would be cleaner with lambdas.
	 * </P>
	 * <P>Don't assume keys are {@link Comparable} though they will be here.
