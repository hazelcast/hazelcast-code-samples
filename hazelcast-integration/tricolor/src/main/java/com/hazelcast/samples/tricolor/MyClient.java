...
/**
 * <P>The client submits a callable, this does some logging
...
public class MyClient implements Runnable {
	...
	/**
	 * <P>Start a client, do something, shutdown.
	 * </P>
	 */
	@Override
	public void run() {
		...
		try {
			...
			log.info("Client is waiting for {} servers", this.countDownLatch.getCount());
