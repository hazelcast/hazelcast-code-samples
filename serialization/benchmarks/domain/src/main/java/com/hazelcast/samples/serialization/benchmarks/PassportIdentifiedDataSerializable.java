 ...
 * </p>
 */
public class PassportIdentifiedDataSerializable implements com.hazelcast.nio.serialization.IdentifiedDataSerializable {
    ...
    public int getClassId() {
        return MyConstants.PASSPORT_IDENTIFIED_DATA_SERIALIZABLE_ID;
    }
    ...
    // Java getters, setters and toString.
     ...
     public String toString() {
          return "PassportIdentifiedDataSerializable [expiryDate=" + expiryDate + ", issuingCountry=" + issuingCountry
