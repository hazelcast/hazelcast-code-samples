...
/**
 * <P>A {@link com.hazelcast.query.extractor.ValueExtractor ValueExtractor} builds
...
public class LifeAgeValueExtractor extends ValueExtractor<LifeValue,Integer> {
	...
	/**
	 * <P>Calculate age in years, an {@code int} not a {@code long}.
	 * </P>
	 * 
	 * @param lifeValue The original object
	 * @param unused An arguments for the extractor
	 * @param valueCollector To add the extracted value
	 */
