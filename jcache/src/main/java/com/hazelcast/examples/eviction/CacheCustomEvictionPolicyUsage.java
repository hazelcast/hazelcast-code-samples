...
public class CacheCustomEvictionPolicyUsage {
    ...
    public static void main(String[] args) {
        ...
        ICache cache1 = (ICache) cacheManager.createCache("MyCache_1", createCacheConfig("MyCache_1", false));
        ...
        ICache cache2 = (ICache) cacheManager.createCache("MyCache_2", createCacheConfig("MyCache_2", true));
    ...
    private static CacheConfig createCacheConfig(String cacheName, boolean evictionPolicyComparatorByName) {
        EvictionConfig evictionConfig =
                evictionPolicyComparatorByName
