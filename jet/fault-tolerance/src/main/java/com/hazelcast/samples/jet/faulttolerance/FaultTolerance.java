...
package com.hazelcast.samples.jet.faulttolerance;
...
public class FaultTolerance {
    ...
    private static void updatePrices(HazelcastInstance hz) {
        IMap<String, Tuple2<Integer, Long>> prices = hz.getMap(PRICES_MAP_NAME);
        int price = 100;
        long timestamp = 0;
        while (true) {
