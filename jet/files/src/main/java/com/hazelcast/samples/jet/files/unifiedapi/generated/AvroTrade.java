 ...
 */
package com.hazelcast.samples.jet.files.unifiedapi.generated;
...
public class AvroTrade extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static AvroTrade.Builder newBuilder() {
    return new AvroTrade.Builder();
  }
   ...
   * @return A new AvroTrade RecordBuilder
   */
  public static AvroTrade.Builder newBuilder(AvroTrade.Builder other) {
    return new AvroTrade.Builder(other);
  }
   ...
   * @return A new AvroTrade RecordBuilder
   */
  public static AvroTrade.Builder newBuilder(AvroTrade other) {
    return new AvroTrade.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroTrade>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(AvroTrade.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(AvroTrade other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.time)) {
        this.time = data().deepCopy(fields()[0].schema(), other.time);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public AvroTrade.Builder setTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public AvroTrade.Builder clearTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public AvroTrade.Builder setTicker(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public AvroTrade.Builder clearTicker() {
      ticker = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public AvroTrade.Builder setQuantity(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public AvroTrade.Builder clearQuantity() {
    ...
    /**
      ...
      * @return This builder.
      */
    public AvroTrade.Builder setPrice(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public AvroTrade.Builder clearPrice() {
