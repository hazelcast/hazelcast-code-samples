...
public final class WindowedCoGroup {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ProducerTask producer = new ProducerTask(hz);
...
//            Pipeline p = coGroupAndAggregate();
    ...
    private static class ProducerTask implements Runnable {
        ...
        ProducerTask(HazelcastInstance hz) {
            pageVisit = hz.getMap(PAGE_VISIT);
            addToCart = hz.getMap(ADD_TO_CART);
            payment = hz.getMap(PAYMENT);
