...
public class MapSourceAndSinks {
    ...
    public MapSourceAndSinks(HazelcastInstance jet) {
        this.hz = jet;
    }
     ...
     */
    private static void dumpMap(HazelcastInstance hz, String mapName) {
        IMap<Object, Object> sinkMap = hz.getMap(mapName);
     ...
     */
    private static void prepareSampleInput(HazelcastInstance hz, String sourceMapName) {
     ...
     * (0,"0") , (1,"1") ....(ITEM_COUNT-1, "ITEM_COUNT-1")
     */
    private static void prepareMapWithUpdatingSampleInput(HazelcastInstance hz, String sourceMapName) {
        IMap<Integer, String> sourceMap = hz.getMap(sourceMapName);
        for (int i = 0; i < ITEM_COUNT; i++) {
